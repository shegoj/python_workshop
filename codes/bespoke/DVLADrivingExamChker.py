...
from DVLACrawlerClasses import Page
import send_sms
...
myTestDateString = 'Friday 30 September 2016 2:00pm'
...
def performUpdate():
	...
	#send_sms.send_sms(myPhoneNum)

	if len(soonerDates):
		sendEmail(soonerDates)
		smsobj =send_sms.SMS_UTILS()
		smsobj.send_sms(myPhoneNum,soonerDates)
